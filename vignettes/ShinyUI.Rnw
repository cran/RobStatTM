...
scale for the variable called V1 in the data set \textbf{flour} (which you need to load) using for the robust estimate the bisquare score function and an asymptotic
efficiency of 90\%.
...
The above, along with figures \ref{f14}, \ref{f15}, and \ref{f16}, correspond to Example 6.2 and Figure 6.3 in Maronna et al. You
may find it of interest run the above example with the
choice "Covariances" changed to "Correlations". A 
command-line equivalent of the Shiny UI interface in Figure
...
Figures \ref{f17} and \ref{f18} use the variables V2, V4, V8, V11, and V12 in the \textbf{wine} dataset.
